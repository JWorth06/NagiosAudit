#nagiosaudit.py
'''
Compares a csv list of services to a csv reported by Nagios XI Reports and reports
it into a csv file.
'''
...
def make_chart(nag_library, auditchecks):
	...
	holder = []
	holder.append("host")
	for it in auditchecks:
		holder.append(it)
	holder.append("extras")
	new_nag_library.append(holder)
...
csv_file_writer('NagiosAudit.csv', audit_library)
